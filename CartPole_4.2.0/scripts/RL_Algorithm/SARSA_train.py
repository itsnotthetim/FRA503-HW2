...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    # n_episodes = 10000
    # start_epsilon = 1.0
    # # epsilon_decay = 0.999  # SARSA_2
    # # epsilon_decay = 0.9995 # SARSA_6
    # epsilon_decay = 0.9997   # SARSA_7
    # final_epsilon = 0.01
    # discount = 0.99
    ...
    wandb.init(project="HW2", name=name_train, config={
        "num_of_action": num_of_action,
        "action_range": action_range,
        "discretize_state_weight": discretize_state_weight,
        "learning_rate": learning_rate,
        ...
        with torch.inference_mode():
            ...
            for episode in tqdm(range(n_episodes)):
                ...
                while not done:
                    ...
                    agent.update(obs, action_idx, reward_value, next_obs, next_action_idx)
                ...
                if episode % 100 == 0:
                    ...
                    wandb.log({"sum_reward": sum_reward/ 100.0,
                               "sum_count": sum_count/ 10000.0,
                               })
                    sum_reward = 0
                    sum_count = 0
